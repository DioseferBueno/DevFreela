        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdUSkill = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserrSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserrSkills_Skills_IdUSkill",
                        column: x => x.IdUSkill,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserrSkills_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserrSkills_IdUser",
                table: "UserrSkills",
                column: "IdUser");

            migrationBuilder.CreateIndex(
                name: "IX_UserrSkills_IdUSkill",
                table: "UserrSkills",
                column: "IdUSkill");
        }
